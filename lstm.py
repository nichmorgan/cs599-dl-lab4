...
# IST597
Routine to create RNN Cells in Tensorflow 2.0.
...
# TF2 doesn't need explicit eager execution activation
# tf.set_random_seed is replaced with tf.random.set_seed
...
class BasicLSTM(tf.keras.Model):
    def __init__(self, units, return_sequence=False, return_states=False, **kwargs):
        ...
        # Define the weights as Dense layers
